...
class SignUpVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    let alreadyHaveAccountButton: UIButton = {
        ...
        attributedTitle.append(NSAttributedString(string: "Login In", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 14), NSAttributedString.Key.foregroundColor: UIColor(red: 17/255, green: 154/255, blue: 237/255, alpha: 1)]))
    ...
    @objc func handleSignUp() {
        ...
        self.successefulVerification()
        
        
    }
    
    
    func successefulVerification() {
    ...
    func signUpAlert() {
        ...
        let alert = UIAlertController(title: "We send you a link to this email \(email)?", message: nil, preferredStyle: .alert)
 ...
 //  self.dismiss(animated: true, completion: nil)
        ...
        alert.addAction(UIAlertAction(title: "Conformed", style: .default, handler: { (action) in
    ...
    func checkYourEmailAgain() {
        ...
        let alert = UIAlertController(title: "Please click the link that we sent to your email so we could conform your email, if you internet slow it might take longer time to recieve the link?", message: nil, preferredStyle: .alert)
